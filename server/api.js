...
/**
 * DELETE /api/resources/:id - 자료 삭제 (비활성화됨)
 * 수동으로 src/data/resources.ts 파일을 편집하세요
 */
app.delete('/api/resources/:id', async (req, res) => {
  res.status(501).json({
    error: 'Delete function disabled',
    message: 'Please manually edit src/data/resources.ts file to delete resources'
  });
});
