...
export function ErrorMessage({ error, lastVideoId }: ErrorMessageProps) {
  return (
        ...
        {error.includes("네트워크 연결 오류") && (
          <div className="mt-3">
            <div className="flex items-start gap-2 p-3 bg-amber-50 border border-amber-100 rounded-lg">
              ...
              <div>
                <p className="font-medium text-amber-800">네트워크 문제 발생</p>
                <p className="mt-1 text-amber-700 text-xs">
                  네트워크 연결을 확인하거나 잠시 후 다시 시도해보세요. 개발 환경에서는 CORS 문제가 발생할 수 있습니다.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-3">
            ...
            <div className="bg-amber-50 border border-amber-100 p-3 mt-3 rounded-lg text-amber-800 text-xs">
              ...
              <ul className="list-disc pl-4 mt-1 space-y-1.5">
                ...
                <li>위에 제공된 예시 URL을 사용해 기능이 작동하는지 확인</li>
              </ul>
            </div>
          </div>
        )}
