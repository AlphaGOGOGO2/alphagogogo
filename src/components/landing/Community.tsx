...
export function Community() {
  ...
  return (
    <section id="community" className="py-24 px-6 md:px-8 bg-gradient-to-b from-purple-50 to-white relative">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white/80 backdrop-blur-sm p-8 md:p-12 rounded-2xl shadow-lg border border-purple-100">
          <div className="md:flex items-center justify-between">
            ...
            <div className="flex flex-wrap gap-4">
              <Link 
                to="/community/join" 
                className="px-6 py-3 rounded-lg bg-gradient-to-r from-violet-600 to-indigo-600 text-white font-medium hover:shadow-lg hover:shadow-purple-200/50 transition-all transform hover:-translate-y-0.5"
              >
                가입하기
              </Link>
              <Link 
                to="/community" 
                className="px-6 py-3 rounded-lg bg-purple-100 text-purple-800 font-medium hover:bg-purple-200 transition-all"
              >
                더 알아보기
              </Link>
            </div>
