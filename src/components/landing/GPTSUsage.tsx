...
export function GPTSUsage() {
  return (
    <section id="gpts-usage" className="py-20 px-6 md:px-8 bg-soft-peach relative">
      {/* Section separator - top wavy line */}
      <div className="absolute top-0 left-0 right-0 h-12 overflow-hidden">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none" className="absolute bottom-0 w-full h-16 text-purple-50 fill-current">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center">
          <Link to="/gpts" className="inline-flex items-center gap-2 px-8 py-3 rounded-lg bg-gradient-to-r from-violet-600 to-indigo-600 text-white font-medium hover:shadow-lg hover:shadow-purple-200/50 transition-all transform hover:-translate-y-0.5">
            GPTS 이용해보기
            <ArrowRight size={16} />
          </Link>
        </div>
